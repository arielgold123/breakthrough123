...
def main ():
    ...
    #player2 = Randomagent(player=-1, env=env, train=True, random=0)   #0.1
    ...
    best_res = -200
    loss_count = 0
    # tester = Tester(player1=player1, player2=Randomagent(player=-1, env=env), env=env)
    ...
    # scheduler = torch.optim.lr_scheduler.MultiStepLR(optim,[100000, 200000, 300000], gamma=0.5)
